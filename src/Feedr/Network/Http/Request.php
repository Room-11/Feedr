 ...
 * @version    1.0.0
 */
namespace Feedr\Network\Http;

use Feedr\Storage\ImmutableKeyValue;
...
{
    /**
     * @var \Feedr\Storage\ImmutableKeyValue The path variables
     */
    private $pathVariables;

    /**
     * @var \Feedr\Storage\ImmutableKeyValue The GET variables
     */
    private $getVariables;

    /**
     * @var \Feedr\Storage\ImmutableKeyValue The POST variables
     */
    private $postVariables;

    /**
     * @var \Feedr\Storage\ImmutableKeyValue The SERVER variables
     */
    private $serverVariables;

    /**
     * @var \Feedr\Storage\ImmutableKeyValue The FILES variables
     */
    private $filesVariables;

    /**
     * @var \Feedr\Storage\ImmutableKeyValue The COOKIES variables
     */
    private $cookies;
     ...
     * Creates instance
     *
     * @param \Feedr\Storage\ImmutableKeyValue $pathVariables   The path variables
     * @param \Feedr\Storage\ImmutableKeyValue $getVariables    The GET variables
     * @param \Feedr\Storage\ImmutableKeyValue $postVariables   The POST variables
     * @param \Feedr\Storage\ImmutableKeyValue $serverVariables The SERVER variables
     * @param \Feedr\Storage\ImmutableKeyValue $filesVariables  The FILES variables
     * @param \Feedr\Storage\ImmutableKeyValue $cookies         The COOKIE variables
     */
