...
use Feedr\Router\Route\Builder;
...
class Router
{
    ...
    /**
     * @var \Feedr\Router\Route\Builder Instance of the route factory
     */
     ...
     * Creates instance
     *
     * @param \Feedr\Router\Route\Builder $routeFactory Instance of a route factory
     */
     ...
     *
     * @return \Feedr\Router\Route\AccessPoint       The route
     * @throws \Feedr\Router\DuplicateRouteException When trying to add an already defined route
     */
